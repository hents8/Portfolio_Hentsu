...
export default function Background() {
  return (
    <section id="background" className="max-w-6xl mx-auto px-6 py-20">
      <h2 className="text-3xl font-bold text-cyan-400 mb-12">Parcours</h2>
      ...
      <div className="grid md:grid-cols-2 gap-12">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h3 className="text-2xl font-semibold text-white mb-6">Expériences Professionnelles</h3>
		  ...
		  <div className="flex-1">
			<div className="flex items-center justify-between">
			  <h4 className="text-lg font-semibold text-cyan-300">Analyste Statistique</h4>
		  ...
		  <div className="flex-1">
		  <div className="flex items-center justify-between">
              <h4 className="text-lg font-semibold text-cyan-300">Data Visualization Analyst</h4>
		  ...
		  <div className="flex-1">
		  <div className="flex items-center justify-between">
              <h4 className="text-lg font-semibold text-cyan-300">Professeur de Mathématiques</h4>
        ...
        <motion.div
		  ...
		  viewport={{ once: true }}
		>
		  <h3 className="text-2xl font-semibold text-white mb-6">Éducation & Certifications</h3>
		  ...
		  <ul className="space-y-4 text-gray-300">
			<li>
			  🎓 <strong>Master 2 / Licence</strong> - Calcul Numérique & Mathématiques Appliquées, Université d'Antananarivo (2019)
				...
				{ <a href="http://biblio.univ-antananarivo.mg/pdfs/rabekotoAndriamarozakaNombainaH_MP_MAST_20.pdf" target="_blank" rel="noreferrer" className="text-cyan-400 underline">Voir</a> }
			</li>
			<li>
			...
			<li>
			  ...
			  { <a href="https://drive.google.com/file/d/11gWinlLGAb51mym94o41TIQ8bL77DLMV/preview" target="_blank" rel="noreferrer" className="text-cyan-400 underline">Voir</a>}
			</li>
			<li>
			  ...
			  { <a href="https://drive.google.com/file/d/18VfF1K-zhKOG5fR2hApDu7eULv7lYqHW/preview" target="_blank" rel="noreferrer" className="text-cyan-400 underline">Voir</a>}
			</li>
			<li>
			  ...
			  { <a href="https://drive.google.com/file/d/1Mj7-NOVFu3fMWxgEBrmjWBKnd2wsPcYl/preview" target="_blank" rel="noreferrer" className="text-cyan-400 underline">Voir</a>}
			</li>
			<li>
			  ...
			  { <a href="https://drive.google.com/file/d/1d_srHppXKFxl8Jgf-GRCea54t-wtr5Hr/preview" target="_blank" rel="noreferrer" className="text-cyan-400 underline">Voir</a>}
			</li>
			<li>
