...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* ░░░ MOBILE TOP BAR ░░░ */}
      <div className="md:hidden w-full px-4 pt-14 relative -top-6 z-20">
        <div className="flex items-start justify-between p-3 -mx-6">
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center gap-10">
        <div className="hidden md:block absolute right-0 top-1/2 -translate-y-1/2 h-[85%] w-[100%] bg-gradient-to-l from-[#404E3B]/70 to-transparent backdrop-blur-1xl rounded-3xl -z-10 shadow-2xl" />
        ...
        <div className="max-w-xl">
          ...
          <motion.p
            className="mt-4 text-lg text-[#B1FB8E]"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          <motion.a
            href="#projects"
            className="inline-block mt-8 px-6 py-3 bg-[#2A3A2A] hover:bg-[#7b9669] text-[#B1FB8E] hover:text-white rounded-lg font-semibold transition-colors"
      ...
      {/* Citation sous la photo (Desktop) */}
      <div
      ...
      {/* ░░░ MOBILE BOTTOM AREA ░░░ */}
      <div className="md:hidden absolute bottom-3 left-0 right-0 z-20 px-2">
